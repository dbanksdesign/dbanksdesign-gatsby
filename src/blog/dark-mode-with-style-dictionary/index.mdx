...
* [Show me the code][multi-file]
* [Show me just the changes in pull request form][multi-file-pr]
...
* [See the just the changes in pull request form](https://github.com/dbanksdesign/style-dictionary-dark-mode/pull/4/files)
