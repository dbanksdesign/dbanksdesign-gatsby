...
export default () => (
<svg viewBox="0 0 420 200" version="1.1" xmlns="http://www.w3.org/2000/svg" style={{border:'var(--size-border-base) solid var(--color-border-secondary)', marginBottom: 'var(--size-padding-large)'}}>
