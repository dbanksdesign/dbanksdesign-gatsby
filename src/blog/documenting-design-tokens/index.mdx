...
2. Some of the examples shown below might not *technically* be design tokens because they are documenting styles in a platform-specific way, such as SCSS variables. The examples shown are still useful in how they display information about the styles as it relates to design tokens. 
